...
import com.api.insurances.backend.cross.dto.AddressResponse;
...
class InsuranceControllerTest {
    ...
    void testCreateInsurance() throws Exception {
        ...
        when(insuranceService.hireInsurance(any())).thenReturn(response);
    ...
    void testSimulateInsurance() throws Exception {
        InsuranceResponse response = createSampleInsuranceResponse();
        when(insuranceService.simulateInsurance(any())).thenReturn(response);
