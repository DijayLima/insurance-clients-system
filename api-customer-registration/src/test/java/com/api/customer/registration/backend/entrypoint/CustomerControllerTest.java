...
import com.api.customer.registration.backend.core.entity.AddressResponse;
...
class CustomerControllerTest {
    ...
    void testGetCustomerById_Success() throws Exception {
        ...
        when(customerGateway.findCustomerByCpf(anyString())).thenReturn(response);
    ...
    void testCreateCustomer_Success() throws Exception {
        CustomerResponse response = createSampleCustomerResponse();
        when(customerGateway.createCustomer(any())).thenReturn(response);
    ...
    void testUpdateCustomer_Success() throws Exception {
        CustomerResponse response = createSampleCustomerResponse();
        when(customerGateway.update(anyString(), any())).thenReturn(response);
    ...
    void testDeleteCustomer_Success() throws Exception {
        doNothing().when(customerGateway).deleteCustomer(anyString());
