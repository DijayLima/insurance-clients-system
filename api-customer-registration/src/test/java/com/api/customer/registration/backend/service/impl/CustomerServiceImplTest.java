...
import com.api.customer.registration.backend.domain.dto.*;
import com.api.customer.registration.backend.domain.mapper.CustomerMapper;
import com.api.customer.registration.backend.model.Address;
...
class CustomerServiceImplTest {
    ...
    public void test_updateNonExistingCustomerWithInvalidCpf() {
        ...
        assertThrows(CustomerException.class, () -> {
            customerService.update(cpf, customerRequestUpdate);
        });
    }
